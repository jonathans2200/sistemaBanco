...
a persistence unit "sistemaBancoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sistemaBanco\pom.xml":
...
artifact ("sistemaBanco.war") is already built. You can build
